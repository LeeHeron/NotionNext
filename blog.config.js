...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '哈基米', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '哦马吉利曼波', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.insertyibaoon.top/about', // 网站地址
