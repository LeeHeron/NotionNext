...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '介鲁大师', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个监护人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.insertyibaoon.top/', // 网站地址
