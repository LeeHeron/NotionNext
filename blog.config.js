...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'bcde399cf695828fa1e301a559dc51c6',
  THEME: process.env.NEXT_PUBLIC_THEME || 'xuhome', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '加菲猫猫', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '有没有好看的大雷', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://garfieldison.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,加菲', // 网站关键词 英文逗号隔开
  ...
  // 自定义外部脚本，外部样式
  LOGO_URL: 'https://i0.hdslb.com/bfs/face/dd44c936944901f7a1d82c5fdb024fac36b2d4a7.jpg@48w_48h_1c_1s.webp', 
